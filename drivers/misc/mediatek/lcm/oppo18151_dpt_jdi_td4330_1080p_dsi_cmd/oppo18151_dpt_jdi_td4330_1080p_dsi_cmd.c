...
** VENDOR_EDIT
** File: - oppo18151_dpt_jdi_td4330_1080p_dsi_vdo.c
** Description: Source file for lcd drvier.
** lcd driver including parameter and power control.
** Version: 1.0
** Date : 2018/11/05
** Author: Yongpeng.Yi@PSW.MultiMedia.Display.LCD.Machine
**
** ------------------------------- Revision History:---------------
** Yongpeng.Yi 2018/11/05 1.0 build this module
*******************************************************************/
...
struct LCM_DRIVER oppo18151_dpt_jdi_td4330_1080p_dsi_cmd_lcm_drv =
{
	.name = "oppo18151_dpt_jdi_td4330_1080p_dsi_cmd",
