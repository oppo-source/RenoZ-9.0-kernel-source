...
#ifdef VENDOR_EDIT
/* Jianchao.Shi@BSP.CHG.Basic, 2019/03/14, sjc Add to correct "Error recovery state" */
...
#ifndef VENDOR_EDIT
/* Jianchao.Shi@BSP.CHG.Basic, 2019/03/14, sjc Delete to correct "Error recovery state" */
	"TYPEC_TIMER_ERROR_RECOVERY",
#endif
